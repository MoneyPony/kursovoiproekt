...
int PrintCourse(struct Course* course, int size);
int addCourse(struct Course* course, int courseCount);
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            courseCount = addCourse(course, courseCount);
            break;
        case 2:
            if (courseCount > 0)
            {
        ...
        case 4:
            ...
            else
            {
                ...
                PrintCourse(course, courseCount);
            }
            break;
        case 5:
            if (courseCount > 0)
